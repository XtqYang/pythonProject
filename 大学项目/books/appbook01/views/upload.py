...
from appbook01.utils.bootstrap import BootStrapForm, BootStrapModelForm
...
#         # 静态static:由于用户访问直接获取的是数据库图片路径，不是真正的图片路径(多了一个appbook01)，我们就把appbook01换成http://127.0.0.1:8000/
#         # db_file_path = os.path.join("static", "img", image_object.name)  # 数据库存储路径
#         # file_path = os.path.join("appbook01", db_file_path)  # 图片存储路径
