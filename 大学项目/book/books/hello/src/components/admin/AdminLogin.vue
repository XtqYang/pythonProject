...
export default {
  ...
  data() {
    return {
      ...
      captchaImageUrl: "http://seqnqc.natappfree.cc/api/image/code/", // 初始化验证码图片地址
      error: "",
    };
  },
  methods: {
    ...
    refreshCaptcha() {
      ...
      this.captchaImageUrl = "http://seqnqc.natappfree.cc/api/image/code/?" + new Date().getTime(); // 添加时间戳以避免缓存
    },
submitForm() {
  axios
      .post('http://seqnqc.natappfree.cc/api/background/login/', {
