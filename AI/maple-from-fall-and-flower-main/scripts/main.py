...
choli = ["常用 优化Tag", "常用 其他Tag", "常用 R18Tag", "环境 朝朝暮暮", "环境 日月星辰", "环境 天涯海角", "风格", "非emoij的人物", "角色", "头发&发饰 长度",
         "头发&发饰 颜色", "头发&发饰 发型", "头发&发型 辫子", "头发&发型 刘海/其他", "头发&发型 发饰", "五官&表情 常用", "五官&表情 R18", "眼睛 颜色", "眼睛 状态",
         "眼睛 其他", "身体 胸", "身体 R18", "服装 衣服", "服装 R18", "袜子&腿饰 袜子", "袜子&腿饰 长筒袜", "袜子&腿饰 连裤袜", "袜子&腿饰 腿饰&组合", "袜子&腿饰 裤袜",
         "袜子&腿饰 R18", "鞋 鞋子", "装饰 装饰", "动作 动作", "动作 头发相关", "动作 R18", "Emoij😊 表情", "Emoij😊 人物", "Emoij😊 手势",
         "Emoij😊 日常", "Emoij😊 动物", "Emoij😊 植物", "Emoij😊 自然", "Emoij😊 食物", "R18 ", "人体", "姿势", "发型", "表情", "眼睛",
         "衣服", "饰品", "袜子", "风格(画质)", "环境", "背景", "物品"]
emoji = ['Emoji 物品 💊医疗7', 'Emoji 旅行和地点 ⛽陆路交通50', 'Emoji 食物和饮料 🍅水果19', 'Emoji 旗帜 🚩旗子8', 'Emoji 笑脸和情感 😛吐舌脸6',
         'Emoji 符号 0️⃣键帽13', 'Emoji 动物和自然 🐍爬行动物8', 'Emoji 人类和身体 👃部分身体18', 'Emoji 符号 ♀️性别3', 'Emoji 动物和自然 🌹花朵11',
         'Emoji 旅行和地点 ☂️天空和天气47', 'Emoji 活动 🎯游戏24', 'Emoji 肤色和发型 🏽肤色5', 'Emoji 物品 📒图书与纸张17', 'Emoji 笑脸和情感 😄笑脸14',
         'Emoji 符号 ⚪️几何34', 'Emoji 笑脸和情感 😸猫咪脸9', 'Emoji 动物和自然 🐓鸟类18', 'Emoji 人类和身体 👌几根手指9', 'Emoji 物品 �居居家25',
         'Emoji 人类和身体 👈一根手指7', 'Emoji 符号 ✖数学符号6', 'Emoji 活动 🏅奖牌6', 'Emoji 活动 🏀运动27', 'Emoji 笑脸和情感 🙈猴子脸3',
         'Emoji 人类和身体 🚴人物运动43', 'Emoji 物品 🖱️电脑14', 'Emoji 笑脸和情感 😠消极脸8', 'Emoji 动物和自然 🌴其他植物16', 'Emoji 食物和饮料 🦀 海产5',
         'Emoji 旅行和地点 ⌚时间31', 'Emoji 动物和自然 🐟海洋动物11', 'Emoji 笑脸和情感 ❤爱心22', 'Emoji 物品 📞电话6', 'Emoji 人类和身体 🏃人物 活动39',
         'Emoji 食物和饮料 ☕饮料20', 'Emoji 笑脸和情感 🤔带手脸7', 'Emoji 符号 ☑️其他符号21', 'Emoji 物品 📢声音9', 'Emoji 人类和身体 🛌人 物休息5',
         'Emoji 人类和身体 👣人物标记5', 'Emoji 笑脸和情感 😍表情脸9', 'Emoji 动物和自然 🐸两栖动物1',
         'Emoji 旗帜 🏴\U000e0067\U000e0062\U000e0065\U000e006e\U000e0067\U000e007f地区旗3', 'Emoji 笑脸和情感 😎眼镜脸3',
         'Emoji 符号 🅰字符39', 'Emoji 符号 ☪️ 宗教12', 'Emoji 物品 💲金钱10', 'Emoji 人类和身体 👨\u200d🍳人物角色82', 'Emoji 旅行和地点 🌍地图7',
         'Emoji 人类和身体 👦人物28', 'Emoji 食物和饮料 🍦甜食14', 'Emoji 物品 🚬其他物品9', 'Emoji 旅行和地点 🏗️建筑27', 'Emoji 物品 ⛏️工具25',
         'Emoji 物品 🔏锁6', 'Emoji 活动 🎨艺术和工艺7', 'Em oji 笑脸和情感 💋情感14', 'Emoji 旅行和地点 ✈️空中运输13', 'Emoji 人类和身体 🎅虚构人物32',
         'Emoji 旅行和地点 ⛲其他场所17', 'Emoji 符号 ↩️箭头21', 'Emoji 笑脸和情感 🤧病脸12', 'Emoji 食物和饮料 🍕熟食34', 'Emoji 肤色和发型 🦱发型4',
         'Emoji 符号 ⚠️警告13', 'Emoji 旗帜 🇬🇧国家或地区   旗258', 'Emoji 动物和自然 🐀哺乳动物64', 'Emoji 物品 💡光线和视频16',
         'Emoji 笑脸和情感 😴睡脸5', 'Emoji 符号 ‼标点7', 'Emoji 旅行和地点 🚢水路交通9', 'Emoji 动物和自然 🐛昆虫16', 'Emoji 物品 🎵音乐9',
         'Emoji 符号 ⏏️视频标志24', 'Emoji 物品 🔭科技7', 'Emoji 食物和饮料 🍴餐具7', 'Emoji 旅行和地点 ⛪宗教场所6', 'Emoji 活动 🎈事件21',
         'Emoji 人类和身体 ✍️动作手3', 'Emoji 符号 🚻功能标识13', 'Emoji 笑脸和情感 🤠带帽脸3', 'Emoji 人类和身体 🙋人物手势30', 'Emoji 物品 🎹乐器9',
         'Emoji 符号 ♈星座13', 'Emoji 物品 👖服饰45', 'Emoji 物品 ✉️邮件13', 'Emoji 食物和饮料 🥬  蔬菜15', 'Emoji 人类和身体 🖐手掌张开9',
         'Emoji 物品 ✏️书写7', 'Emoji 符号 💲货币2', 'Emoji 笑脸和情感 🤐中性脸-怀疑脸13', 'Emoji  笑脸和情 感 💩装扮脸8', 'Emoji 旅行和地点 🌋地理9',
         'Emoji 物品 ✂️办公23', 'Emoji 人类和身体 👨\u200d👩\u200d👧\u200d👦家庭38', 'Emoji 笑脸和情感 😞担忧脸26', 'Emoji 人类和身体 👍合上手掌6',
         'Emoji 人类和身体 🤝双手7', 'Emoji 食物和饮料 🍚亚洲食物17', 'Emoji 旅行和地点 🛎️酒店2']
...
def seach(inp, num, sf="search", yin="yinyin", yinli=[], start=0):
    ...
    if len(inp) != 0:
        ...
        inputbehind = [it for it in input if
                       inp not in it.get("tags") and inp not in it.get("chin").replace("\\n", " ")]
        ...
        input = sorted(ddd, key=lambda item: int(
            (item.get("num") or str(item.get("index")))), reverse=(True if sf == "search" else False))
    return [
        [i.get("tags") + "【" + i.get("chin").replace("\\n", " ") + "】【" + (i.get("num") or str(i.get("index"))) + "】",
         i.get("index"), len(input)] for i in input[start:num]]
...
def radio_to_out(li, rad, sab, cho="one_tags"):
    ...
    for it in yuan:
        ...
        if "【特殊符号：" in it:
            word = word.split("$")[0]
        if ind != len(yuan) - 1 and "【特殊符号：" in yuan[ind + 1] and (
                yuan[ind + 1].split("$")[0] == "|" or yuan[ind + 1].split("$")[0] == ":" or yuan[ind + 1].split("$")[
            0] == "::") and "【特殊符号：" not in it and (
                ind == 0 or set(list(yuan[ind + 1].split("$")[0])) != set(list(yuan[ind - 1].split("$")[0]))):
            qian = "["
        else:
            qian = ""
        if "【特殊符号：" in it:
            if ind == 0 or ind == len(yuan) - 1 or set(list(yuan[ind + 1].split("【")[0].split("$")[0])) == set(
                    list(word)):
                add = word + " "
                hou = ""
            ...
            num = int(num)
            add = qian + fu[0] * num + word + fu[1] * num + hou + (
                ", " if word in sab and (ind != len(yuan) - 1 or "最后一个去逗号" not in getItem("set_little", [])) and (
                            ind == len(yuan) - 1 or "【特殊符号：" not in yuan[ind + 1]) else " ")
            hou = ""
        else:
            add = qian + fu[0] + word + ":" + str(num + 1) + fu[1] + hou + (
                ", " if word in sab and (ind != len(yuan) - 1 or "最后一个去逗号" not in getItem("set_little", [])) and (
                            ind == len(yuan) - 1 or "【特殊符号：" not in yuan[ind + 1]) else " ")
            hou = ""
        text += add
...
def check_to_sub(check, radio, li, su, bas, sab, little, clear=False):
    ...
    ssab = [it.split("【")[0].replace("?(&&", "").replace("?[&&", "").replace("?{&&", "") for it in check if
            it[0] == "?"]
    ...
    bas1, bas, sba1, sab, li1, li, text, ccansteps, ccanface, ccanseed, ccanwidth, ccanheight, ccansamples, ccancfg, ccansteps, ccanface, ccanseed, ccanwidth, ccanheight, ccansamples, ccancfg = lit_to_bassab(
        little, biansm, sab, li, *canmo)
    setItem("set_dro", li)
    if not clear:
        return gr.update(choices=yuan), radio if radio in yuan or len(yuan) == 0 else yuan[0], text, gr.update(
            choices=yuans), bas, li, gr.update(choices=yuans), sab
    else:
        return gr.update(choices=yuan), radio if radio in yuan or len(yuan) == 0 else yuan[0], text, gr.update(
            choices=yuans), bas, li, gr.update(choices=yuans), sab, []
...
def zhou_to_check(nname):
    ...
    if yuan.get(nname):
        yuan = yuan.get(nname)
        check = [it if type(it) == str else ((tags[it[1]], it[2]) if it[0] == "search" else (ddict[it[1]], it[2])) for
                 it in yuan[2]]
        bas = [it if type(it) == str else (tags[it[1]]["tags"] if it[0] == "search" else ddict[it[1]]["tags"]) for it in
               yuan[1]]
        sab = [it if type(it) == str else (tags[it[1]]["tags"] if it[0] == "search" else ddict[it[1]]["tags"]) for it in
               yuan[3]]
        check = [it.split("&&")[1] if type(it) == str else it[0].get("tags") + "【" + it[0].get("chin").replace("\\n",
                                                                                                               " ") + "】【" + (
                                                                       it[0].get("num") or str(
                                                                   it[0].get("index"))) + "】—" + str(it[1]) + "—" for it
                 in check]
        check = [("?" if it.split("【")[0] not in sab else "") + ("(" if it.split("【")[0] in bas else "{") + "&&" + it
                 for it in check]
...
def zhou_to_out(nname, check):
    ...
    out, bas, sab = radio_to_out(cho="zancun", li=yuan[0], rad=[
        it if type(it) == str else (tags[it[1]].get("tags") if it[0] == "search" else ddict[it[1]].get("tags")) for it
        in yuan[1]], sab=[
        it if type(it) == str else (tags[it[1]].get("tags") if it[0] == "search" else ddict[it[1]]).get("tags") for it
        in yuan[1]] if len(yuan) == 2 else [
        it if type(it) == str else (tags[it[1]].get('tags') if it[0] == "search" else ddict[it[1]].get("tags")) for it
        in yuan[3]])
    return out
...
def delete_one_to_out(radio, li, bas, sab):
    ...
    return gr.update(choices=yuan), yuan[0] if len(yuan) != 0 else None, text, gr.update(choices=yuans), bas, gr.update(
        choices=yuans), sab
...
def cheese_to_all(warn, cheese):
    ...
    reduce = [
        (it[2] if it[2] == "" else it[2] + "&&") + tags[it[0]].get("tags") + "【" + tags[it[0]].get("chin").replace(
            "\\n", " ") + "】【" + tags[it[0]].get("num") + "】【" + it[3] + "】—" + str(it[1]) + "—" for it in
        file.get("reduce")]
    img = [path + "/images/magic" + "@".join(re.findall(r"\d", warn)) + "/" + it for it in
           os.listdir(path + "/images/magic" + "@".join(re.findall(r"\d", warn)) + "/") if it.split("@")[0] == cheese]
    ...
    return gr.update(choices=add), gr.update(choices=reduce), gr.update(choices=imgcho), imgcho[0], img[0], gr.update(
        label=cheese), warn, add, reduce, gr.update(choices=addcheck), addcheck, gr.update(
        choices=reducecheck), reducecheck
...
def lit_to_bassab(little, bas, sab, li, ccansteps, ccanface, ccanseed, ccanwidth, ccanheight, ccansamples, ccancfg):
    ...
    return gr.update(visible=bigvisit and smavisit), bas, gr.update(visible=sabvisit), sab, gr.update(
        visible=bigvisit and smavisit), li, out, *(
        canmo if "其他参数为默认值" in little else [ccansteps, ccanface, ccanseed, ccanwidth, ccanheight, ccansamples,
                                            ccancfg]), gr.update(visible=("其他参数为默认值" not in little)), gr.update(
        visible=("其他参数为默认值" not in little)), gr.update(visible=("其他参数为默认值" not in little)), gr.update(
        visible=("其他参数为默认值" not in little)), gr.update(visible=("其他参数为默认值" not in little)), gr.update(
        visible=("其他参数为默认值" not in little)), gr.update(visible=("其他参数为默认值" not in little))


def image_appear(warning, name, num):
    num = int(num.split("第")[1].split("张")[0]) - 1
    warning = warning.split("\n")[0].split("典")[1].split("的")[0]
    img = [path + "/images/magic" + "@".join(re.findall(r"\d", warning)) + "/" + it for it in
           os.listdir(path + "/images/magic" + "@".join(re.findall(r"\d", warning)) + "/") if it.split("@")[0] == name]
    return img[num]
...
def zhou_to_cun(name, li, rad, sab):
    ...
    yuan = [("?" if it.split("【")[0] not in sab else "") + ("(" if it.split("【")[0] in rad else "{") + "&&" + it for it
            in yuan]
...
def zhou_del(nname):
    ...
    return zhou_to_appear(), gr.update(choices=[]), [], "", (
...
if dictperfect:
    def cun_settings(sstep, sbig, ssmall, tbig, tsmall, ttbig, ttsmall):
        ...
        return gr.update(step=sstep, minimum=ssmall, maximum=sbig), sstep, sbig, ssmall, gr.update(minimum=tsmall,
                                                                                                   maximum=tbig), tbig, tsmall, gr.update(
            minimum=ttsmall, maximum=ttbig), ttbig, ttsmall
else:
    def cun_settings(sstep, sbig, ssmall, tbig, tsmall):
        ...
        return gr.update(step=sstep, minimum=ssmall, maximum=sbig), sstep, sbig, ssmall, gr.update(minimum=tsmall,
                                                                                                   maximum=tbig), tbig, tsmall


def out_to_out(input, bas, sab):
    yuan = getVar("one_tags", [])
    yuan = [re.sub(r"\$\d+【", "$【", it) for it in yuan]
    yuan = [("?" if it.split("【")[0] not in sab else "") + ("(" if it.split("【")[0] in bas else "{") + "&&" + it for it
            in yuan]
...
def change_tabs(change, warn, cheese, goodcheck, badcheck):
    good1, bad1, imagecho1, imagecho2, image1, image2, warn, good2, bad2, goodcheck1, goodcheck2, badcheck1, badcheck2 = cheese_to_all(
        warn, cheese)
    for it in change:
        if it[3] == "改":
...
if not tiao:
    def send_prompt(tabname, textpower, buttons, addaor=[], addtextpower=[]):
        aor = addaor + ['Prompt', 'Negative prompt', 'Steps', 'Face restoration'] + (
            ["Seed"] if shared.opts.send_seed else []) + ['Size-1', 'Size-2']
...
def on_ui_tabs():
    with gr.Blocks() as block:
        with gr.Column():
            ...
            bas1, bas2, sab1, sab2, dro1, dro2, txt, ccansteps, ccanface, ccanseed, ccanwidth, ccanheight, ccansamples, ccancfg, ccansteps, ccanface, ccanseed, ccanwidth, ccanheight, ccansamples, ccancfg = lit_to_bassab(
                getItem("set_little", []), [], [], getItem("set_dro", li[0]), *canmo)
            with gr.Row():
                with gr.Column(scale=9):
                    bas = gr.CheckboxGroup(type="value", label="此处是调节大小括号混合(选中为小括号)", visible=bas1.get("visible"),
                                           elem_id="warning")
                ...
                with gr.Column(scale=1):
                    maohao = gr.Slider(minimum=getItem("set_small", -20), maximum=getItem("set_big", 20),
                                       step=getItem("set_step", 0.000001), label="此处可拉动选择括号权重", value=0)
                    ...
                    cansteps = gr.Slider(visible=("其他参数为默认值" not in getItem("set_little", [])), interactive=True,
                                         minimum=1, maximum=150, value=20, step=1, label="(调节参数)采样迭代步数")
                    canface = gr.CheckboxGroup(visible=("其他参数为默认值" not in getItem("set_little", [])), interactive=True,
                                               choices=['Restore faces'], value=[], label="(调节参数)面部修复")
                    canwidth = gr.Slider(visible=("其他参数为默认值" not in getItem("set_little", [])), interactive=True,
                                         minimum=64, maximum=2048, value=512, step=64, label="(调节参数)宽度")
                    canheight = gr.Slider(visible=("其他参数为默认值" not in getItem("set_little", [])), interactive=True,
                                          minimum=64, maximum=2048, value=512, step=64, label="(调节参数)高度")
                    canseed = gr.Number(visible=("其他参数为默认值" not in getItem("set_little", [])), value=-1,
                                        label="(调节参数)随机种子", interactive=True)
                    cancfg = gr.Slider(visible=("其他参数为默认值" not in getItem("set_little", [])), interactive=True,
                                       minimum=1, maximum=30, value=7, step=1, label="(调节参数)提示词相关性")
                    cansamples = gr.Radio(visible=("其他参数为默认值" not in getItem("set_little", [])), interactive=True,
                                          choices=["Euler a", "Euler", "LMS", "Heun", "DPM2", "DPM2 a", "DPM++ 2S a",
                                                   "DPM++ 2M", "DPM++ SDE", "DPM fast", "DPM adaptive", "LMS Karras",
                                                   "DPM2 Karras", "DPM2 a Karras", "DPM++ 2S a Karras",
                                                   "DPM++ 2M Karras", "DPM++ SDE Karras", "DDIM"], value="Euler a",
                                          label="(调节参数)采样方法")
            with gr.Row():
                with gr.Column(scale=9):
                ...
                with gr.Column(scale=1):
                    dro = gr.Dropdown(choices=li, value=dro2, interactive=True, label="此处选择增强符号形式",
                                      visible=dro1.get("visible"))
                    little = gr.CheckboxGroup(
                        choices=["全部使用大括号(优先级低)", "全部使用小括号(优先级高)", "全部后加逗号", "最后一个去逗号", "其他参数为默认值"],
                        value=getItem("set_little", []), label="一些选项")
        ...
        with gr.Tab(label="单个咒语书柜"):
            ...
            with gr.Row():
                with gr.Column(scale=9):
                    check = gr.CheckboxGroup(choices=[it[0] for it in seach("", getItem("set_num", 100))],
                                             label="此处是单个咒语搜索结果", value=[])
                with gr.Column(scale=1):
                    sub = gr.Button(value="在所有tag末尾提交所有单个咒语")
                    subding = gr.Button(value="在选中tag前面添加所有单个咒语")
                    r18 = gr.CheckboxGroup(choices=["R18", "emoji细分类", "按下enter键时搜索才生效"],
                                           value=getItem("set_r1818", []), label="一些选项")
                    num = gr.Slider(minimum=getItem("set_text_small", 1), maximum=getItem("set_text_big", 500), step=1,
                                    value=getItem("set_num", 100), label="此处是调整搜索结果个数")
            cho.change(fn=text_to_check, inputs=[cho, num, r18, check, yin], outputs=[check, check])
            text.change(fn=lambda *it: text_to_check(*it) if "按下enter键时搜索才生效" not in it[2] else (it[3], it[3]),
                        inputs=[text, num, r18, check, yin], outputs=[check, check])
            ...
            sub.click(fn=check_to_sub, inputs=[check, radio, dro, sub, bas, sab, little],
                      outputs=[radio, radio, out, bas, bas, dro, sab, sab])
            subding.click(fn=check_to_sub, inputs=[check, radio, dro, subding, bas, sab, little],
                          outputs=[radio, radio, out, bas, bas, dro, sab, sab])
                ...
                for item in mag:
                    with gr.Tab(label=item):
                        ...
                        with gr.Row():
                            with gr.Column(scale=2):
                                warn = gr.Textbox(lines=10, value="此处是元素法典" + item + "的各种使用技巧和提示：\n\n" + names[
                                    0] + "：\n\n细节：" + file.get("detail") + "\n\n可改进：" + file.get(
                                    "progress") + "\n\n其他设置：" + file.get("settings"), interactive=False,
                                                  label="此处是您的元素法典使用说明书")
                            with gr.Column(scale=1):
                                img = [path + "/images/magic" + "@".join(re.findall(r"\d", item)) + "/" + it for it in
                                       os.listdir(path + "/images/magic" + "@".join(re.findall(r"\d", item)) + "/") if
                                       it.split("@")[0] == names[0]]
                        ...
                        with gr.Row():
                            ...
                            goodcho = [(it[2] if it[2] == "" else it[2] + "&&") + tags[it[0]].get("tags") + "【" + tags[
                                it[0]].get("chin").replace("\\n", " ") + "】【" + tags[it[0]].get("num") + "】【" + it[
                                           3] + "】—" + str(it[1]) + "—" for it in
                                       magic.get(item).get(names[0]).get("add")]
                            badcho = [(it[2] if it[2] == "" else it[2] + "&&") + tags[it[0]].get("tags") + "【" + tags[
                                it[0]].get("chin").replace("\\n", " ") + "】【" + tags[it[0]].get("num") + "】【" + it[
                                          3] + "】—" + str(it[1]) + "—" for it in
                                      magic.get(item).get(names[0]).get("reduce")]
                            with gr.Column():
                        ...
                        cheese.change(fn=cheese_to_all, inputs=[warn, cheese],
                                      outputs=[good, bad, imagecho, imagecho, image, image, warn, good, bad, goodcheck,
                                               goodcheck, badcheck, badcheck])
                        imagecho.change(fn=image_appear, inputs=[warn, cheese, imagecho], outputs=image)
                        goodcheck.change(
                            fn=lambda its, war, chee: [it for it in cheese_to_all(war, chee)[0].get("choices") if
                                                       ifinnot(it, ["【" + i + "】" for i in its])],
                            inputs=[goodcheck, warn, cheese], outputs=good)
                        badcheck.change(
                            fn=lambda its, war, chee: [it for it in cheese_to_all(war, chee)[1].get("choices") if
                                                       ifinnot(it, ["【" + i + "】" for i in its])],
                            inputs=[badcheck, warn, cheese], outputs=bad)
                        goodsub.click(fn=check_to_sub, inputs=[good, radio, dro, goodsub, bas, sab, little],
                                      outputs=[radio, radio, out, bas, bas, dro, sab, sab])
                        badsub.click(fn=check_to_sub, inputs=[bad, radio, dro, badsub, bas, sab, little],
                                     outputs=[radio, radio, out, bas, bas, dro, sab, sab])
                        goodsubding.click(fn=check_to_sub, inputs=[good, radio, dro, goodsubding, bas, sab, little],
                                          outputs=[radio, radio, out, bas, bas, dro, sab, sab])
                        badsubding.click(fn=check_to_sub, inputs=[bad, radio, dro, badsubding, bas, sab, little],
                                         outputs=[radio, radio, out, bas, bas, dro, sab, sab])
        if dictperfect:
            with gr.Tab(label="遗失魔法碎片"):
                with gr.Row():
                    with gr.Column(scale=9):
                        ...
                        ccheck = gr.CheckboxGroup(
                            choices=[it[0] for it in seach("", getItem("set_nnum", 100), sf="find", yin="yyinyin")],
                            label="此处是搜索结果", value=[])
                    with gr.Column(scale=1):
                        ssub = gr.Button(value="在所有tag末尾提交可能遗失的魔法碎片")
                        ssubding = gr.Button(value="在选中tag前面添加可能遗失的魔法碎片")
                        nnum = gr.Slider(minimum=getItem("set_ttext_small", 1), maximum=getItem("set_ttext_big", 500),
                                         step=1, value=getItem("set_nnum", 100), label="此处是调整搜索结果个数")
                        ...
                        yyin = gr.CheckboxGroup(choices=[it for it in getItem("yyinyin", {})], value=[],
                                                label="此处为隐藏关键词")
                ...
                ssub.click(fn=check_to_sub, inputs=[ccheck, radio, dro, ssub, bas, sab, little],
                           outputs=[radio, radio, out, bas, bas, dro, sab, sab])
                ssubding.click(fn=check_to_sub, inputs=[ccheck, radio, dro, ssubding, bas, sab, little],
                               outputs=[radio, radio, out, bas, bas, dro, sab, sab])
                ...
                yyin.change(fn=lambda yin, text, num, check: ttext_to_check(text, num, check, yin),
                            inputs=[yyin, ttext, nnum, ccheck], outputs=[ccheck, ccheck])
        with gr.Tab(label="你的私藏禁术"):
            with gr.Row():
                with gr.Tab(label="自定义收藏咒语组合"):
                    ...
                    zhouradio = gr.Radio(label="此处是你的收藏咒语组合列表", choices=zhouyu,
                ...
                with gr.Tab(label="自定义收藏单个咒语"):
                    ...
                    tagradio = gr.Radio(label="此处是你的单个咒语收藏列表", choices=alltag,
                                        value=alltag[0] if len(alltag) != 0 else None)
                    tagout = gr.Textbox(label="此处是你选中的单个咒语", lines=10, max_lines=100,
                                        value=getItem("tagcun", {}).get(alltag[0] if len(alltag) != 0 else None))
                with gr.Tab(label="自定义embeddings中咒语"):
                    ...
                    ptcheck = gr.CheckboxGroup(choices=pt_refresh([])[0].get("choices"), value=[],
...
融合描绘不可嵌套，但同样支持逗号分割。融合描绘擅长将两种事物混合为一起，比如 a [dog | frog] in black background。""",
                    ...
                    shuradio = gr.Radio(choices=[it for it in shushu], value=[it for it in shushu][0],
                                        label="此处是常见占位符与特殊字符列表")
                    shuout = gr.Textbox(label="此处是该特殊字符的说明", lines=10, max_lines=100,
            ...
            zhoubutton.click(fn=check_to_sub, inputs=[zhoucheck, radio, dro, zhoubutton, bas, sab, little],
                             outputs=[radio, radio, out, bas, bas, dro, sab, sab])
            zhouqian.click(fn=check_to_sub, inputs=[zhoucheck, radio, dro, zhouqian, bas, sab, little],
                           outputs=[radio, radio, out, bas, bas, dro, sab, sab])
            zhoudel.click(fn=zhou_del, inputs=zhouradio, outputs=[zhouradio, zhoucheck, zhoucheck, zhouout, zhouradio])
            tagbutton.click(fn=check_to_sub, inputs=[tagout, radio, dro, tagbutton, bas, sab, little],
                            outputs=[radio, radio, out, bas, bas, dro, sab, sab])
            tagqian.click(fn=check_to_sub, inputs=[tagout, radio, dro, tagqian, bas, sab, little],
                          outputs=[radio, radio, out, bas, bas, dro, sab, sab])
            tagdel.click(fn=tag_del, inputs=tagradio, outputs=[tagradio, tagout, tagradio])
            ptbutton.click(fn=check_to_sub, inputs=[ptcheck, radio, dro, ptbutton, bas, sab, little],
                           outputs=[radio, radio, out, bas, bas, dro, sab, sab])
            ptqian.click(fn=check_to_sub, inputs=[ptcheck, radio, dro, ptqian, bas, sab, little],
                         outputs=[radio, radio, out, bas, bas, dro, sab, sab])
            ptrefresh.click(fn=pt_refresh, inputs=ptcheck, outputs=[ptcheck, ptcheck])
            shubutton.click(fn=lambda *it: check_to_sub(addtime(it[0]), *it[1:]),
                            inputs=[shuradio, radio, dro, shubutton, bas, sab, little],
                            outputs=[radio, radio, out, bas, bas, dro, sab, sab])
            shuqian.click(fn=lambda *it: check_to_sub(addtime(it[0]), *it[1:]),
        ...
        with gr.Tab(label="基础草药材料"):
            ...
            if dictperfect:
                cun.click(fn=cun_settings, inputs=[sstep, sbig, ssmall, tbig, tsmall, ttbig, ttsmall],
                          outputs=[maohao, sstep, sbig, ssmall, num, tbig, tsmall, nnum, ttbig, ttsmall])
            else:
                cun.click(fn=cun_settings, inputs=[sstep, sbig, ssmall, tbig, tsmall],
        ...
        deleteone.click(fn=delete_one_to_out, inputs=[radio, dro, bas, sab],
        ...
        maohao.change(fn=lambda radio, maohao: but_to_radio(radio=radio, cho=maohao), inputs=[radio, maohao],
                      outputs=radio)
        ...
        little.change(fn=lit_to_bassab,
                      inputs=[little, bas, sab, dro, cansteps, canface, canseed, canwidth, canheight, cansamples,
                              cancfg],
                      outputs=[bas, bas, sab, sab, dro, dro, out, cansteps, canface, canseed, canwidth, canheight,
                               cansamples, cancfg, cansteps, canface, canseed, canwidth, canheight, cansamples, cancfg])
        toout.click(fn=out_to_out, inputs=[out, bas, sab], outputs=negout)
        outto.click(fn=lambda *it: check_to_sub(getVar("two_tags", []), *it),
                    inputs=[radio, dro, outto, bas, sab, little], outputs=[radio, radio, out, bas, bas, dro, sab, sab])
        outqian.click(fn=lambda *it: check_to_sub(getVar("two_tags", []), *it),
                      inputs=[radio, dro, outqian, bas, sab, little],
                      outputs=[radio, radio, out, bas, bas, dro, sab, sab])
        if not tiao:
            try:
                send_prompt("txt2img", [out, negout, cansteps, canface, canseed, canwidth, canheight], txt2imgbutton,
                            addaor=["Sampler", "CFG scale"], addtextpower=[cansamples, cancfg])
                send_prompt("img2img", [out, negout, cansteps, canface, canseed, canwidth, canheight], img2imgbutton,
                            addaor=["Sampler", "CFG scale"], addtextpower=[cansamples, cancfg])
            except:
...
def onebenupdate(benben):
    if benben == 2:
        ...
        for it in zhoucun:
            item = zhoucun.get(it)
            item = [item[0]] + [[sseach(re.sub(r"\??[\(\[\{]?&{0,2}", "", its.split("【")[0]),
                                        float(its.split("—")[1] if "—" in its else 0)) or its for its in itss] for itss
                                in item[1:]]
            if len(item) == 3:
                item.append(
                    [it if type(it) == list else re.sub(r"\??[\(\[\{]?&{0,2}", "", it.split("【")[0]) for it in item[2]])
