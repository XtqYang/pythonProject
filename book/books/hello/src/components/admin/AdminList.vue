  ...
  <div class="emoji-wrapper">
    ...
    <div>
      <div class="button-container">
        ...
        <el-button @click="showDialog">+新增管理员</el-button>
...
export default {
  ...
  methods: {
    loadUsers() {
      axios
          .get("http://seqnqc.natappfree.cc/api/administrator/")
          .then((response) => {
    ...
    submitForm() {
      ...
      axios
          .post("http://seqnqc.natappfree.cc/api/administrator/", newUser)
          .then((response) => {
            // 添加成功后，刷新管理员列表
            this.loadUsers();
    ...
    deleteUser(id) {
      axios
          .delete(`http://seqnqc.natappfree.cc/api/administrator/${id}`)
          .then((response) => {
    ...
    submitEdit(user) {
      user.editPopoverVisible = false;
      axios
          .put(`http://seqnqc.natappfree.cc/api/administrator/${user.id}/`, this.editingUser)
          .then((response) => {
