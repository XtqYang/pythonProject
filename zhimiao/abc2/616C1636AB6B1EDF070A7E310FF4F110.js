...
e = (t = r).lib.WordArray, t.enc.Base64 = {
    ...
    f = f.MD5 = a.extend({
        ...
        _doProcessBlock: function (t, r) {
            ...
            o = this._hash.words;
            var a = t[r + 0], f = (c = t[r + 1], t[r + 2]), u = t[r + 3], p = t[r + 4], d = t[r + 5], l = t[r + 6],
                y = t[r + 7], _ = t[r + 8], v = t[r + 9], g = t[r + 10], B = t[r + 11], x = t[r + 12], m = t[r + 13],
                k = t[r + 14], S = t[r + 15], z = e(z = o[0], D = o[1], C = o[2], w = o[3], a, 7, h[0]),
                w = e(w, z, D, C, c, 12, h[1]), C = e(C, w, z, D, f, 17, h[2]), D = e(D, C, w, z, u, 22, h[3]);
            ...
            _createHelper: function (t) {
                return {
                    encrypt: function (e, r, i) {
                        ...
                        console.log(("string" == typeof r ? y : d).encrypt(t, e, r, i))
