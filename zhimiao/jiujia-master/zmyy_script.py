...
class Zmyy(object):
    ...
    def _request(self, url, data, *, method="post", **kwargs):
        ...
        data_map = {"method": method, "url": self._url(kwargs.get("host", self.host), url), "timeout": 3,
    ...
    def _header(self) -> json:
        headers = {
            'Cookie': 'ASP.NET_SessionId=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..kJz4WTnvcuOGBUAfeLAjtWbDkJiK0cQKlJtJFJlrG5g',
    ...
    def yan_zheng_code(self, mxid):
        ...
        response, request_instance = self._request(url="/sc/wx/HandlerSubscribe.ashx", method="get", data=payload,
                                                   need_request=True)
    ...
    def send_order_post(self, mxid, scdate):
        ...
        response, request_instance = self._request(url="/sc/api/User/OrderPost", data=postContext, method="post",
                                                   need_request=True)
...
if __name__ == "__main__":
    # 先填cookie和医院id
    zmyy = Zmyy(
        cookie='eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..fn3jFjV5_XYXoHkkUdrZGOz86xM2UsRqlQbEbxksx5g',
        hospital_id=4050
    )
    zmyy.main()
